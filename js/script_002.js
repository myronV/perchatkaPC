function Stimer() {
	...
	function e(t, e) {
		var n = document.querySelectorAll(t + " .sc-sec"), i = document.querySelectorAll(t + " .sc-min"),
			o = document.querySelectorAll(t + " .sc-hour"), r = document.querySelectorAll(t + " .sc-day"),
	...
	function n(t) {
		for (var e = [], n = document.querySelectorAll(t), i = 0; i < n.length; i++) {
			var o = document.createElement("span"), r = document.createElement("span"),
				s = document.createElement("span"), a = document.createElement("span");
...
if (function (t, e) {
	...
	function S(t, e, n) {
		var i = !0, o = "width" === e ? t.offsetWidth : t.offsetHeight, r = Be(t),
	...
	var _ = [], B = _.slice, z = _.concat, U = _.push, V = _.indexOf, X = {}, Q = X.toString, Z = X.hasOwnProperty,
		Y = {}, K = t.document, G = "2.1.1", J = function (t, e) {
	...
	var oe = function (t) {
		...
		function v(t, e, n, o, r, s) {
			return o && !o[R] && (o = v(o)), r && !r[R] && (r = v(r, s)), i(function (i, s, a, l) {
				var c, u, p, d = [], f = [], h = s.length, v = i || g(e || "*", a.nodeType ? [a] : a, []),
					y = !t || !i && e ? v : m(v, d, t, a, l), b = n ? r || (i ? t : h || o) ? [] : s : y;
		...
		function b(t, n) {
			var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, c) {
				var u, p, d, f = 0, h = "0", g = i && [], v = [], y = D, b = i || r && C.find.TAG("*", c),
		...
		var x, w, C, T, k, E, S, $, D, N, j, A, L, H, O, P, M, W, q, R = "sizzle" + -new Date, F = t.document, I = 0,
			_ = 0, B = n(), z = n(), U = n(), V = function (t, e) {
				return t === e && (j = !0), 0
			}, X = "undefined", Q = 1 << 31, Z = {}.hasOwnProperty, Y = [], K = Y.pop, G = Y.push, J = Y.push, te = Y.slice,
			...
			pe = new RegExp("=" + ie + "*([^\\]'\"]*?)" + ie + "*\\]", "g"), de = new RegExp(ae),
			fe = new RegExp("^" + re + "$"), he = {
				ID: new RegExp("^#(" + oe + ")"),
				CLASS: new RegExp("^\\.(" + oe + ")"),
			...
			ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, be = /[+~]/, xe = /'|\\/g,
			we = new RegExp("\\\\([\\da-f]{1,6}" + ie + "?|(" + ie + ")|.)", "ig"), Ce = function (t, e, n) {
				var i = "0x" + e - 65536;
			...
			filter: {
				TAG: function (t) {
					...
					return 1 === i && 0 === o ? function (t) {
						...
						var c, u, p, d, f, h, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode,
	...
	J.Callbacks = function (t) {
		...
		Deferred: function (t) {
			...
			var e, n, i, o = 0, r = B.call(arguments), s = r.length,
	...
	var Se = /^key/, $e = /^(?:mouse|pointer|contextmenu)|click/, De = /^(?:focusinfocus|focusoutblur)$/,
		Ne = /^([^.]*)(?:\.(.+)|)$/;
	J.event = {
		global: {},
		...
		trigger: function (e, n, i, o) {
			var r, s, a, l, c, u, p, d = [i || K], f = Z.call(e, "type") ? e.type : e,
		...
		dispatch: function (t) {
			t = J.event.fix(t);
			var e, n, i, o, r, s = [], a = B.call(arguments), l = (ve.get(this, "events") || {})[t.type] || [],
	...
	var je = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ae = /<([\w:]+)/,
		Le = /<|&#?\w+;/, He = /<(?:script|style|link)/i, Oe = /checked\s*(?:[^=]|=\s*.checked.)/i,
		Pe = /^$|\/(?:java|ecma)script/i, Me = /^true\/(.*)/, We = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, qe = {
	...
	var ze = /^(none|table(?!-c[ea]).+)/, Ue = new RegExp("^(" + we + ")(.*)$", "i"),
		Ve = new RegExp("^([+-])=(" + we + ")", "i"),
	...
	var Ye, Ke, Ge = /^(?:toggle|show|hide)$/, Je = new RegExp("^(?:([+-])=|)(" + we + ")([a-z%]*)$", "i"),
		tn = /queueHooks$/, en = [L], nn = {
			"*": [function (t, e) {
				var n = this.createTween(t, e), i = n.cur(), o = Je.exec(e), r = o && o[3] || (J.cssNumber[t] ? "" : "px"),
					s = (J.cssNumber[t] || "px" !== r && +i) && Je.exec(J.css(n.elem, t)), a = 1, l = 20;
				if (s && s[3] !== r) {
					r = r || s[3], o = o || [], s = +i || 1;
	...
	J.Animation = J.extend(O, {
		...
		fadeTo: function (t, e, n, i) {
			...
			return t !== !1 && (t = t || "fx"), this.each(function () {
				var e, n = ve.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = J.timers,
					s = i ? i.length : 0;
	...
	var dn, fn, hn = /#.*$/, gn = /([?&])_=[^&]*/, mn = /^(.*?):[ \t]*([^\r\n]*)$/gm,
		vn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, yn = /^(?:GET|HEAD)$/, bn = /^\/\//,
		xn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, wn = {}, Cn = {}, Tn = "*/".concat("*");
	try {
		fn = location.href
	} catch (kn) {
	...
	dn = xn.exec(fn.toLowerCase()) || [], J.extend({
		...
		ajax: function (t, e) {
			...
			var i, o, r, s, a, l, c, u, p = J.ajaxSetup({}, e), d = p.context || p,
				f = p.context && (d.nodeType || d.jquery) ? J(d) : J.event, h = J.Deferred(),
				g = J.Callbacks("once memory"), m = p.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
	...
	J.ajaxSetup({
		...
		var o, r, s,
			a = e.jsonp !== !1 && (Pn.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Pn.test(e.data) && "data");
	...
	n.extend(a, {
		...
		_setDimension: function () {
			var t, e, i, o, r, s, l, c, u, p, d, h, v, y, b, x = a.getViewport(), w = 0, C = !1, T = !1, k = a.wrap,
				E = a.skin, S = a.inner, $ = a.current, D = $.width, N = $.height, j = $.minWidth, A = $.minHeight,
				L = $.maxWidth, H = $.maxHeight, O = $.scrolling, P = $.scrollOutside ? $.scrollbarWidth : 0,
				M = $.margin, W = g(M[1] + M[3]), q = g(M[0] + M[2]);
		...
		_getPosition: function (t) {
			var e = a.current, n = a.getViewport(), i = e.margin, o = a.wrap.width() + i[1] + i[3],
				r = a.wrap.height() + i[0] + i[2], s = {position: "absolute", top: i[0], left: i[3]};
		...
		getOrigPosition: function () {
			var t = a.current, e = t.element, n = t.orig, i = {}, o = 50, r = 50, s = t.hPadding, l = t.wPadding,
				c = a.getViewport();
...
+function (t) {
	...
	t.fn.collapse = e, t.fn.collapse.Constructor = n, t.fn.collapse.noConflict = function () {
		...
		var i, o = t(this),
			...
			s = t(r), a = s.data("bs.collapse"), l = a ? "toggle" : o.data(), c = o.attr("data-parent"), u = c && t(c);
	...
	n.VERSION = "3.2.0", n.DEFAULTS = {
		...
		var p = u.left ? 2 * u.left - o + l : 2 * u.top - r + c, d = u.left ? "left" : "top",
	...
	n.VERSION = "3.2.0", n.RESET = "affix affix-top affix-bottom", n.DEFAULTS = {
		...
		if (this.$element.is(":visible")) {
			var e = t(document).height(), i = this.$target.scrollTop(), o = this.$element.offset(),
				r = this.options.offset, s = r.top, a = r.bottom;
	...
	window.onload = function () {
		...
		var e = new Stimer;
		e.init(["2200", "12", "30"], ".scount", function () {
